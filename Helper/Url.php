...
class Url extends \Magento\Framework\App\Helper\AbstractHelper
{
     ...
     */
    const ROUTE_ACCOUNT_LOGIN = 'lofhelpdesk/customer/login';
    ...
    public function getLoginPostUrl()
    {
         ...
         */
        return $this->urlBuilder->getUrl('lofhelpdesk/customer/loginPost', $params);
    }
    ...
    public function getDashboardUrl()
    {
         ...
         */
        return $this->urlBuilder->getUrl('lofhelpdesk/customer/dashboard');
    }
    ...
    public function getRegisterUrl()
    {
         ...
         */
        return $this->urlBuilder->getUrl('lofhelpdesk/customer/create');
    }
    ...
    public function getRegisterPostUrl()
    {
         ...
         */
        return $this->urlBuilder->getUrl('lofhelpdesk/customer/createpost');
    }
