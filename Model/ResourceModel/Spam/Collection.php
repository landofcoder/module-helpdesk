...
namespace Lof\HelpDesk\Model\ResourceModel\Spam;
...
class Collection extends AbstractCollection
{
    ...
    {
        $this->_init('Lof\HelpDesk\Model\Spam', 'Lof\HelpDesk\Model\ResourceModel\Spam');
    }
    ...
    {
        return $this->_toOptionArray('spam_id', 'title');
    }
