...
namespace Lof\HelpDesk\Model\ResourceModel\Quickanswer;

use \Lof\HelpDesk\Model\ResourceModel\AbstractCollection;

class Collection extends AbstractCollection
{
    protected $_idFieldName = 'quickanswer_id';
    /**
    ...
    {
        $this->_init('Lof\HelpDesk\Model\Quickanswer', 'Lof\HelpDesk\Model\ResourceModel\Quickanswer');
    }
    ...
    {
        return $this->_toOptionArray('quickanswer_id', 'title');
    }
