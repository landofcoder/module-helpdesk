...
namespace Lof\HelpDesk\Model\ResourceModel\AbstractReport;

use Magento\Framework\DB\Select;

class Ticketcollection extends \Magento\Framework\Model\ResourceModel\Db\Collection\AbstractCollection
{
    protected $_main_table_id = 'main_table.ticket_id';
    protected $_status_field = 'main_table.status_id';
    /**
     * Store ids
     *
     * @var int|array
    ...
    {
        $this->_init('Lof\HelpDesk\Model\Ticket', 'Lof\HelpDesk\Model\ResourceModel\Ticket');
    }
