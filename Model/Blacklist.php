...
class Blacklist extends \Magento\Framework\Model\AbstractModel
{
     ...
     * @param \Lof\HelpDesk\Model\ResourceModel\Blacklist|null            $resource
     * @param \Lof\HelpDesk\Model\ResourceModel\Blacklist\Collection|null $resourceCollection
     * @param array                                                        $data
     */
    public function __construct(
        \Magento\Framework\Model\Context $context,
        \Magento\Framework\Registry $registry,
        \Lof\HelpDesk\Model\ResourceModel\Blacklist $resource = null,
        \Lof\HelpDesk\Model\ResourceModel\Blacklist\Collection $resourceCollection = null,
        array $data = []
    ) {
    ...
    {
        $this->_init('Lof\HelpDesk\Model\ResourceModel\Blacklist');
    }
