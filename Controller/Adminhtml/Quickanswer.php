 ...
 */
abstract class Quickanswer extends \Magento\Backend\App\Action
{
    /**
     * Core registry
     *
    ...
    {
        $resultPage->setActiveMenu('Lof_HelpDesk::lofhelpdesk_quickanswer')
            ->addBreadcrumb(__('HelpDesk'), __('HelpDesk'))
            ->addBreadcrumb(__('Quickanswer'), __('Quickanswer'));
        return $resultPage;
    }
