...
namespace Lof\HelpDesk\Controller\Adminhtml\Blacklist;

class Edit extends \Lof\HelpDesk\Controller\Adminhtml\Blacklist
{
    /**
     * Edit Chat Blacklist
     *
    ...
    public function execute()
    {
        ...
        $this->dataPersistor->set('lofhelpdesk_blacklist', $model->getData());
        $this->_coreRegistry->register('lofhelpdesk_blacklist', $model);
