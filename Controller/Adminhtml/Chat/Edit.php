...
class Edit extends \Lof\HelpDesk\Controller\Adminhtml\Chat
{
    /**
    ...
    {
        return $this->_authorization->isAllowed('Lof_HelpDesk::chat_edit');
    }
    ...
    public function execute()
    {
        ...
        $this->_coreRegistry->register('lofhelpdesk_chat', $model);
