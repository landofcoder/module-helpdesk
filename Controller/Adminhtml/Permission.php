...
abstract class Permission extends \Magento\Backend\App\Action
{
    ...
    {
        $resultPage->setActiveMenu('Lof_HelpDesk::lofhelpdesk_permission')
            ->addBreadcrumb(__('HelpDesk'), __('HelpDesk'))
            ->addBreadcrumb(__('Permission'), __('Permission'));
        return $resultPage;
    }
    ...
    {
        return $this->_authorization->isAllowed('Lof_HelpDesk::permission');
    }
}
