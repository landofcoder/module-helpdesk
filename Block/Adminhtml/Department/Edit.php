...
namespace Lof\HelpDesk\Block\Adminhtml\Department;
...
class Edit extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    protected function _construct()
    {
        ...
        if ($this->_isAllowedAction('Lof_HelpDesk::department_save')) {
        ...
        if ($this->_isAllowedAction('Lof_HelpDesk::department_delete')) {
    ...
    {
        if ($this->_coreRegistry->registry('lofhelpdesk_department')->getId()) {
            return __("Edit Message '%1'", $this->escapeHtml($this->_coreRegistry->registry('lofhelpdesk_department')->getTitle()));
        } else {
